#!/bin/bash
# ======================================
# TP MongoDB - Script Automatizado (Linux)
# Crea base, colecciones, inserts, índices y consultas
# ======================================

echo "Iniciando configuración de la base 'myapp'..."
...
// ================================
print("=== Productos con categorías ===");
...
print("=== Pedidos con usuario y productos ===");
db.orders.aggregate([
  {
    $lookup: {
      from: "users",
...
print("Configuración de la base 'myapp' completada correctamente.");
EOF
